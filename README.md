# 麒智 · 知识与人才资料工作台
**QylinIntel Data Workbench** · 资料入库、知识资产与人才样本管理。

面向需要整理业务材料和人才资料的团队，将分散文件转为可检索、可复核的资产。项目已从早期面试与邮箱导入工具演进，当前主要页面是知识资产、人才样本和系统设置；仓库保留的方案 Agent 等历史模块不代表当前导航全部开放。

[线上工作台](https://ai.etgq.com/) · [安全说明](SECURITY.md) · [开发协作](CONTRIBUTING.md)
